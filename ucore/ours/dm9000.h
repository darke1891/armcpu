...
//DM9000_BUSCR
#define BUSCR_8mA     (3<<5) //default
#define BUSCR_10mA   (4<<5)
#define BUSCR_12mA   (5<<5)
#define BUSCR_14mA   (6<<5)
#define BUSCR_16mA   (7<<5)
...
/* SKIP_CRC/SKIP_LONG */
#define DM9000_RCR_SET0x30
/* IMR */
#define DM9000_IMR_SET0xA3
/* Packet ready to receive */
#define DM9000_PKT_RDY0x01
/* Received packet max size */
#define DM9000_PKT_MAX1536
#define DM9000_DISINTR0x80


//DM9000 PHY registers
#define DM9000_PHY_BMCR    0x00
#define DM9000_PHY_BMSR    0x01
#define DM9000_PHY_PHYIDR1 0x02
#define DM9000_PHY_PHYIDR2 0x03
...
#define DM9000_PHY_DSP     0x1B
#define DM9000_PHY_PSCR    0x1D
